...
@Component({
  template: `
    ...
    <div id="modalBackdrop" class="modal-backdrop in"></div>
    <!-- <div class="modal fade" id="confirmationModal" tabindex="-1" role="dialog" aria-labelledby="confirmationModal" aria-hidden="true"></div>-->
